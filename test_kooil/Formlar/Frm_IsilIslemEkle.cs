...
{
    public partial class Frm_IsilIslemEkle : Form
    {
        public Frm_IsilIslemEkle()
        {
            InitializeComponent();
        }
        DB_kooil_testEntities db = new DB_kooil_testEntities();
        private void Frm_IsilIslemEkle_Load(object sender, EventArgs e)
        {
        ...
        private void Btn_Kaydet_Click(object sender, EventArgs e)
        {
            try
            {
                if (lookUp_Siparis.EditValue != null && date_BasimTarihi.EditValue != null)
                {
                    ...
                    TBL_ISILISLEM islenenUrun = new TBL_ISILISLEM();
