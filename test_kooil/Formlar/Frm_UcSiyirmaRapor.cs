...
{
    public partial class Frm_UcSiyirmaRapor : Form
    {
        public Frm_UcSiyirmaRapor()
        {
            InitializeComponent();
        }
        ...
        void listele()
        {
            var veriler = (from x in db.TBL_RAPOR
                           ...
                           }).ToList().OrderByDescending(x => x.Tarih).Where(x => x.ISLEM == "Uc Siyirma");

            gridControl1.DataSource = veriler;
            gridView1.Columns[7].Visible = false;
        }
        private void Frm_UcSiyirmaRapor_Load(object sender, EventArgs e)
        {
            listele();
        }
