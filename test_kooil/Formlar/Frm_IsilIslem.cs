...
{
    public partial class Frm_IsilIslem : Form
    {
        public Frm_IsilIslem()
        {
            InitializeComponent();
        }
        DB_kooil_testEntities db = new DB_kooil_testEntities();
        Frm_IsilIslemEkle frmEkle;
        Frm_IsilIslemRapor frmRapor;
        void listele()
        {
        ...
        private void Btn_Raporlar_Click(object sender, EventArgs e)
        {
            ...
            {
                frmRapor = new Frm_IsilIslemRapor();
                frmRapor.MdiParent = this.ParentForm;
                frmRapor.Show();
            }
        }

        private void Frm_IsilIslem_Load(object sender, EventArgs e)
        {
            listele();
        }
