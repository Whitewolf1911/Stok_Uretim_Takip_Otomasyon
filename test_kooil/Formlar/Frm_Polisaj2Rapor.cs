...
{
    public partial class Frm_Polisaj2Rapor : Form
    {
        public Frm_Polisaj2Rapor()
        {
            InitializeComponent();
        }
        ...
        void listele()
        {
            var veriler = (from x in db.TBL_RAPOR    // change this !!!
                           ...
                           }).ToList().OrderByDescending(x => x.TARIH).Where(x => x.ISLEM == "Polisaj2");
        ...
        private void Frm_Polisaj2Rapor_Load(object sender, EventArgs e)
        {
            listele();
        }
