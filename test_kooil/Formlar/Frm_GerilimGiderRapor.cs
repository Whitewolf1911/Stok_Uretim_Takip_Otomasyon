...
{
    public partial class Frm_GerilimGiderRapor : Form
    {
        public Frm_GerilimGiderRapor()
        {
            InitializeComponent();
        }
        ...
        void listele()
        {
            try
            {
                var veriler = (from x in db.TBL_RAPOR // change this !!!
                               ...
                               }).ToList().OrderByDescending(x => x.Tarih).Where(x => x.ISLEM == "GerilimGiderme");
        ...
        private void Frm_GerilimGiderRapor_Load(object sender, EventArgs e)
        {
            listele();
        }
