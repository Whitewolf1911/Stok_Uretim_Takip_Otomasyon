...
{
    public partial class Frm_AyakKesmeRapor : Form
    {
        public Frm_AyakKesmeRapor()
        {
            InitializeComponent();
        }
        ...
        void listele()
        {
            try
            {
                var veriler = (from x in db.TBL_RAPOR // change this !!!
                               ...
                               }).ToList().OrderByDescending(x => x.Tarih).Where(x => x.ISLEM == "AyakKesme");
        ...
        private void Frm_AyakKesmeRapor_Load(object sender, EventArgs e)
        {
            listele();
        }
