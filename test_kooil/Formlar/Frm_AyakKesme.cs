...
{
    public partial class Frm_AyakKesme : Form
    {
        public Frm_AyakKesme()
        {
            InitializeComponent();
        }
        DB_kooil_testEntities db = new DB_kooil_testEntities();
        Frm_AyakKesmeEkle frmEkle;
        Frm_AyakKesmeRapor frmRapor;
        ...
        private void Frm_AyakKesme_Load(object sender, EventArgs e)
        {
            listele();
        }
        ...
        private void Btn_Raporlar_Click(object sender, EventArgs e)
        {
            ...
            {
                frmRapor = new Frm_AyakKesmeRapor();
