...
{
    public partial class Frm_BilemeRapor : Form
    {
        public Frm_BilemeRapor()
        {
            InitializeComponent();
        }
        ...
        void listele()
        {
            var veriler = (from x in db.TBL_RAPOR // change this !!!
                           ...
                           }).ToList().OrderByDescending(x => x.TARIH).Where(x => x.ISLEM == "Bileme");

            gridControl1.DataSource = veriler;

        }
        private void Frm_BilemeRapor_Load(object sender, EventArgs e)
        {
            listele();
        }
        ...
        private void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (gridView1.GetFocusedRowCellValue("TARIH") != null) { txt_Tarih.EditValue = gridView1.GetFocusedRowCellValue("TARIH"); }
