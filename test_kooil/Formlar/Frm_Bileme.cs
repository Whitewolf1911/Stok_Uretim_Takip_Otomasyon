...
{
    public partial class Frm_Bileme : Form
    {
        public Frm_Bileme()
        {
            InitializeComponent();
        ...
        Frm_BilemeRapor frmRapor;
        Frm_BilemeEkle frmEkle;
        void listele()
        {
        ...
        private void Frm_Bileme_Load(object sender, EventArgs e)
        {
            listele();
        }
    }
